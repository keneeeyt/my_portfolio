...
import WriteTestimonial from "./write-testimonial";
import { TypewriterEffectSmooth } from "./ui/typewriter-effect";
import axios from "axios";

const Testimonials = () => {
  const [testimonialsData, setTestimonialsData] = useState<any[]>([]); // eslint-disable-line
  const [isLoading, setIsLoading] = useState<boolean>(true);
   const [userData, setUserData] = useState<any>(() => { // eslint-disable-line
  ...
  const [ref, inView] = useInView({ triggerOnce: true, threshold: 0.1 });
    ...
    useEffect(() => {
      ...
      // Listen to the storage event to detect changes in other tabs
  ...
  const getData = async () => {
    const resp = await axios.get("/api/testimonial");
    setTestimonialsData(resp.data.testimonilas);
    setIsLoading(false);
  };
  ...
  return (
    <section id="testimonials" className="relative w-full mt-5">
      <div className="w-full text-left relative">
        ...
        <motion.h1
          ...
          className="absolute -ml-6 top-20 -translate-y-1/2 text-[10rem] font-bold text-gray-400 opacity-5 tracking-wider select-none leading-none whitespace-nowrap"
          style={{
        ...
        >
          <h2
            className="relative text-7xl tracking-wide font-semibold text-gray-400"
            style={{ fontFamily: "The Coastal, sans-serif" }}
          >
            Some <span>good words</span>
          </h2>
        </motion.div>

        {/* SVG Arrow - Rotate In */}
        <motion.svg
          initial={{ opacity: 0, rotate: 20, scaleY: -1, scale: 0.9 }}
          animate={controls}
          variants={{
            visible: {
              opacity: 1,
          ...
          className="absolute right-36 top-24 rotate-[215deg] w-[120px] scale-x-[-1] md:block hidden"
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <motion.div
        ...
        className="mt-5 h-[50vh] md:h-[30rem] rounded-md flex flex-col antialiased  items-center justify-center relative overflow-hidden"
      >
        {!isLoading ? (
          testimonialsData.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-[40rem]">
              ...
              <WriteTestimonial getData={getData}  setUserData={setUserData} />
            </div>
          )
        ) : (
          <div className="flex flex-col items-center justify-center h-[40rem]">
            <svg
              className="animate-spin h-10 w-10 text-neutral-800 dark:text-neutral-300"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            >
